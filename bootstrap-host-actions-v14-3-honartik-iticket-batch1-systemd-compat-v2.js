...
const OLD_SHA='7d5bb5148e06ba9f101250e07f46a9026caa2870373596a2cffe1aa4de468ccb';
const NEEDLE=",'--property=LockPersonality=true'";
...
function execute(){
  ...
  const backup='/var/backups/prhm-honartik-iticket-v14-3-systemd-compat-v2-'+Date.now(); fs.mkdirSync(backup,{recursive:true,mode:0o700});
