...
function apply(){const started_at=new Date().toISOString(),targetEvidence=verifyTargetRoots();verifyBaselines();const c=buildCandidates(),backup=backupOriginals(),mutated=[];try{
