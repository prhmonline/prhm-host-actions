...
const EXPECTED=Object.freeze({
  ...
  exec:'c85394fcaa857413bb7918cb55ed2210890f5431be8c9b58e67e93c12898f6ce',
...
function patchExec(input){
  ...
  const health="return json(res, 200, { ok: true, service: 'prhm-agent-selfmaint-exec', version: '1.1.0-host-actions-v1', host_actions: [HOST_ACTION_NAME], base: sanitize(base) });";
