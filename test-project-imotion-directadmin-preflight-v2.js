...
assert.match(src,/const DA_TARGET='10\.71\.0\.10'/);
...
console.log(JSON.stringify({ok:true,test:'imotion-directadmin-preflight-v2-contract',production_mutation:false}));
