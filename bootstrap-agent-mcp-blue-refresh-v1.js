...
const ACTION='agent_mcp_blue_refresh_v1';
...
const PATHS=Object.freeze({
  ...
  backupRoot:'/var/backups/prhm-agent-mcp-blue-refresh',
  latest:'/var/backups/prhm-agent-mcp-blue-refresh/latest.json'
});
...
const EXPECTED_SHA=Object.freeze({
  ...
  [PATHS.safeFiles]:'92e6e279f10fe8561a9c986d9dc90d6bc0cd284009ed9984f51fefe202ac6252',
...
class ProductionAdapter{
  ...
  async verifyFinalizeState(){const ptr=pointerInfo();return sourceShaMatch()&&ptr.regular&&ptr.blue&&isActive(UNITS.router)&&isActive(UNITS.blue)&&isActive(UNITS.green)&&await endpointOk(PORTS.blue,'/health','ok')&&await endpointOk(PORTS.blue,'/ready','ready');}
