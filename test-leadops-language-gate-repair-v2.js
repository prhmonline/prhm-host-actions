...
test('transient timer is never stopped or restarted by language gate',()=>{const o=r.patchSource(fixture);assert.doesNotMatch(o,/systemctl\(\['stop','leadops-parscoders-v3\.timer'/);assert.doesNotMatch(o,/restoreParscodersTimer\(timerWasActive\)/)});
